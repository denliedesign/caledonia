        ...
        <div class="py-5" id="class-schedule">
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
                    <div class="col my-2">
                        <a href="/images/summer-23.pdf" target="_blank">
                            <img src="/images/summer-23a.jpg" alt="fall schedule" class="img-fluid shadow rounded" style="width: 100%; height: auto;">
                        </a>
                    </div>
                    <div class="col my-2">
                        <a href="/images/summer-23.pdf" target="_blank">
                            <img src="/images/summer-23b.jpg" alt="fall schedule" class="img-fluid shadow rounded" style="width: 100%; height: auto;">
                        </a>
                    </div>
{{--                    <div class="col my-2">--}}
