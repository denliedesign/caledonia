...
@section('title', 'Dance Studios in Byron Center MI | Caledonia Dance & Music Center')
@section('description', 'Elevate your child\'s passion for dance at Caledonia Dance & Music Center near Byron Center. Our exceptional dance classes and dedicated instructors create the perfect environment for growth and creativity. Discover the leading destination for dance in Byron Center.')
@section('content')
    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            <div class="row">
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-classes-in-byron-center.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Premier Dance Classes Near Byron Center</h3>
            ...
            <div class="row">
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Meet Our Accomplished Instructors</h3>
                    <p class="font-syne" style="font-size: 22px;">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-lessons-in-byron-center.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
            </div>
            <hr class="my-5">
            <div class="row">
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-studios-in-byron-center.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Nurturing Values Through Dance</h3>
                    <p class="font-syne" style="font-size: 22px;">
