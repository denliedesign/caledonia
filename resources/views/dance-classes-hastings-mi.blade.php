...
@section('title', 'Dance Classes in Hastings MI | Caledonia Dance & Music Center')
@section('description', 'Discover the Art of Dance at CDMC: Your Destination for Dance Classes, Lessons, and More in Hastings, MI. Explore a World of Creativity and Expression!')
@section('content')
    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            <div class="row">
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-lessons-in-hastings-mi.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Unleash Your Child's Potential with Dance Classes in Hastings, MI</h3>
            ...
            <div class="row">
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Meet Our Dedicated Instructors of Dance in Hastings, MI</h3>
                    <p class="font-syne" style="font-size: 22px;">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-studios-in-hastings-mi.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
            </div>
            <hr class="my-5">
            <div class="row">
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="/images/dance-classes-in-hastings-mi.jpg" alt="dancers" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm">
                    <h3 class="font-staat" style="font-size: 100px; line-height: 0.9em;">Embracing Values Through the Art of Dance</h3>
                    <p class="font-syne" style="font-size: 22px;">
