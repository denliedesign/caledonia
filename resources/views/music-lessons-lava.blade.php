    ...
    <div class="bg-white">
        <div class="container my-5">
            <div class="container d-flex justify-content-around align-items-center mb-5">
                <div class="row">
                    <div class="col-sm my-1"><img src="/images/music-1.jpg" class="shadow rounded img-fluid"></div>
                    <div class="col-sm my-1"><img src="/images/music-2.jpg" class="shadow rounded img-fluid"></div>
                </div>
            </div>
            <h2 class="text-center mt-3 font-staat-side">Music Lessons</h2>
        ...
        <div class="bg-red text-white py-3 mb-5" style="position: relative;">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3">
                        <h4 class="text-center font-staat-side">Age</h4>
                        <p class="font-syne-side">
        ...
        <div class="container my-5">
            ...
            <h2 class="text-center mt-3 font-staat-side">Music FunTime</h2>
            <p class="lead-side text-center">
