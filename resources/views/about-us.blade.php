...
@section('content')
    ...
    <div class="bg-white">
        ...
        <div class="container py-5">
            <h2 class="text-center mt-3">About Caledonia Dance & Music Center</h2>
...
{{--                <li><strong>HASSLE-FREE RECITALS –</strong> No performance fees, free recital DVD, two complimentary recital tickets and beautifully designed yearbook-style programs.  We fit and alter costumes so you don't have to.  Organized, fast, and fun dress rehearsals.  Family-friendly shows that aren't too long.  </li>--}}
            ...
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="text-center">The Walker Family</h4>
                        <p class="font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="text-center">Kelly Mulry, Caledonia</h4>
                        <p class="font-italic">
        ...
        <div class="background-green py-3 mb-5">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="text-center">Jackie Baum, Caledonia</h4>
                        <p class="font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="text-center">Dawn Ostrander, Wayland</h4>
                        <p class="font-italic">
        ...
        <div class="container my-5">
            <h2 class="text-center mt-3">Six Things Every Parent Should Know Before Choosing a Studio</h2>
        ...
        <div class="background-green py-3">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="text-center">Sheila Workman, Middleville</h4>
                        <p class="font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="text-center">Mikhail Baryshnikov</h4>
                        <p class="font-italic">
