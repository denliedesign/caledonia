...
{{--    </div>--}}
    ...
    <div class="my-5" id="class-schedule">
        ...
        <div class="container">
            ...
            <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=383292&Session=Summer&hidecols=Gender,Ages,Session,Openings"></script>
        </div>
    </div>
