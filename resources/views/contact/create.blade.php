<form action="{{ route('contact.store') }}" method="POST" class="text-dark" id="contactForm">
    ...
    <div class="form-group mb-3 form-check">
        <input required type="checkbox" class="form-check-input" name="privacy_policy" id="privacy_policy" value="1" {{ old('privacy_policy') ? 'checked' : '' }}>
