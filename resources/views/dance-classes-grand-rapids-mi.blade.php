            ...
            <div class="py-5">
                <div class="row">
                    <div class="col-sm d-flex align-items-center">
                        <div>
                            <h1 class="text-center">Dance Studios in Grand Rapids, MI: Where Your Child Can Grow and Excel</h1>
                            <p class="text-center">
                                Looking for top-rated dance classes in Grand Rapids, MI for kids? Look no further than our dance studio! Our experienced dance instructors specialize in teaching ballet, jazz, hip hop, tap, and more. Our classes are designed to be engaging, fun, and challenging, so your child can develop their skills and confidence as a dancer. We offer a range of dance classes for all ages and skill levels, including dance classes for toddlers, preschoolers, and school-aged children. Whether your child is new to dance or has been dancing for years, we have the perfect class for them.
                            </p>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="d-flex justify-content-center">
                            <img src="/images/dance-grand-rapids-mi.jpg" alt="young dance friends in class" class="img-fluid shadow rounded">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white">
        <div class="container py-5">
            <div class="row my-5">
                <div class="col-sm">
                    <div class="d-flex justify-content-center">
                        <img src="/images/dance-studios-grand-rapids-mi.jpg" alt="two contemporary dancers on stage" class="img-fluid shadow rounded">
                    </div>
                </div>
                <div class="col-sm d-flex align-items-center">
                    <div class="">
