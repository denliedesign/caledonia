...
@section('content')
    ...
    <div class="bg-white">
        <div class="container py-5">
            <h2 class="font-staat-side text-center mt-3">About Caledonia Dance & Music Center</h2>
            <p class="font-syne-side lead-side text-center">
                Why Caledonia Dance & Music Center is the Best Choice for Your Family:
            </p>
            <ol class="font-syne-side">
        ...
        <div class="text-white bg-red py-3 mb-5" style="position:relative;">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="font-staat-side text-center">The Walker Family</h4>
                        <p class="font-syne-side font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="font-staat-side text-center">Kelly Mulry, Caledonia</h4>
                        <p class="font-syne-side font-italic">
        ...
        <div class="container d-flex justify-content-around align-items-center mb-5">
            <div class="row">
                <div class="col-sm">
                    <img src="/images/about-1.jpg" alt="img-fluid" class="my-1">
                </div>
                <div class="col-sm">
                    <img src="/images/about-2.jpg" alt="img-fluid" class="my-1">
                </div>
                <div class="col-sm">
                    <img src="/images/about-3.jpg" alt="img-fluid" class="my-1">
                </div>
            </div>
        </div>
        ...
        <div class="text-white bg-red py-3 mb-5" style="position: relative;">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="font-staat-side text-center">Jackie Baum, Caledonia</h4>
                        <p class="font-syne-side font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="font-staat-side text-center">Dawn Ostrander, Wayland</h4>
                        <p class="font-syne-side font-italic">
        ...
        <div class="container my-5">
            <h2 class="font-staat-side text-center mt-3">Six Things Every Parent Should Know Before Choosing a Studio</h2>
            <div class="six-things">
                <div class="row mt-3">
                    <div class="col-1 number-green">1</div>
                    <div class="col-10 d-flex align-items-center">
                        <p class="font-syne-side lead-side mb-0">
            ...
            <div class="six-things">
                <div class="row mt-3">
                    ...
                    <div class="col-10 d-flex align-items-center">
                        <p class="font-syne-side lead-side mb-0">
                            What kinds of dance moves will my child learn and will the costumes be appropriate?
                        </p>
                    </div>
                </div>
                <p class="font-syne-side">
            ...
            <div class="six-things">
                <div class="row mt-3">
                    <div class="col-1 number-green">6</div>
                    <div class="col-10 d-flex align-items-center">
                        <p class="font-syne-side lead-side mb-0">
                            Does it really matter which place you decide to enroll your child?
                        </p>
                    </div>
                </div>
                <p class="font-syne-side">
        ...
        <div class="text-white bg-red py-3">
            <div class="container d-flex align-items-center">
                <div class="row">
                    <div class="col-sm px-3 border-right border-white">
                        <h4 class="font-staat-side text-center">Sheila Workman, Middleville</h4>
                        <p class="font-syne-side font-italic">
                    ...
                    <div class="col-sm px-3">
                        <h4 class="font-staat-side text-center">Mikhail Baryshnikov</h4>
                        <p class="font-syne-side font-italic">
