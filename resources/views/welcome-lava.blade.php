...
{{--                        <h2 class="text-center font-staat-side text-white" style="font-size: 1.5em;">Recital 2026</h2>--}}
{{--                    </div>--}}
...
{{--                        <img src="/images/recital-tickets-26.jpg" alt="ballerinas in training logo" class="img-fluid rounded" style="height: 175px; width: auto;">--}}
{{--                    </div>--}}
{{--                    <div class="d-flex justify-content-center">--}}
...
{{--    <div>--}}
{{--        <div style="background: white; width: 300px; height: 300px; top: 200px;" id="side-recital" class="offcanvas offcanvas-end show shadow" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">--}}
{{--            <div class="offcanvas-header p-0 mt-2" style="position: relative;">--}}
{{--                <div class="d-flex justify-content-center" style="width: 100%;">--}}
