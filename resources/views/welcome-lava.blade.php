...
@section('content')
        ...
        <div>
            <div style="background: #3D1951; width: 300px; height: 300px; top: 175px;" id="side-trial" class="offcanvas offcanvas-end show shadow" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
...
{{--            <div class="offcanvas-header p-0 mt-2" style="position: relative;">--}}
{{--                <div class="d-flex justify-content-center" style="width: 100%;">--}}
{{--                    <h2 class="text-center font-staat-side" style="font-size: 1.5em;">Fall 2024</h2>--}}
{{--                </div>--}}
{{--                <div style="position: absolute; top: 10px; right: 0; z-index: 4;">--}}
{{--                    <button class="mx-2" type="button" data-bs-dismiss="offcanvas" aria-label="Close" style="background: transparent; border: none;">--}}
{{--                        <ion-icon name="close-outline" style="color: black; font-size: 2em;"></ion-icon>--}}
