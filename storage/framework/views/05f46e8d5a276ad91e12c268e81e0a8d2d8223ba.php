<span class="text-red"><ion-icon name="heart"></ion-icon></span> Floating Floors
<br><span class="text-red"><ion-icon name="heart"></ion-icon></span> 5 Dance Studios
<br><span class="text-red"><ion-icon name="heart"></ion-icon></span> 5-6 Guest Artists Each Year
...
<?php /**PATH C:\Users\Dennis\caledonia\resources\views/_parents-love-list.blade.php ENDPATH**/ ?>